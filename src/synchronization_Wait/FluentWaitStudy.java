...
public class FluentWaitStudy {
	...
	public static void main(String[] args) 
	{
		...
		Wait<WebDriver> w=new FluentWait<WebDriver>(driver).withTimeout(Duration.ofMillis(5000)).pollingEvery(Duration.ofMillis(1000)).ignoring(NoSuchElementException.class);
